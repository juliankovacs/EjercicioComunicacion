...
if (isset($_SESSION["historialtecni"])) {
  $historial_tecni = $_SESSION["historialtecni"];
} else {
  $historial_tecni = array(); // Inicializa un array vacío si no hay historial
}
...
<body>
  <header>
    ...
    <nav>
      ...
      <a href="formulario_cliente.php" class="nav-line">Volver</a>
    </nav>
  </header>
  <section>
    <?php
  ...
  <div class="container">
    <h2>Historial de Escritos Enviados por Tecnico</h2>
      <?php
      if (empty($historial_tecni)) {
        echo "<p>No se han enviado escritos por tecnicos previamente.</p>";
      } else {
        echo "<ul>";
        foreach ($historial_tecni as $escrito) {
          echo "<li>Título: " . $escrito['titulo'] . "</li>";
          echo "<li>Usuario: " . $escrito['usuario'] . "</li>"; 
          echo "<li>Contenido: " . $escrito['contenido'] . "</li>";
          echo "<hr>";
